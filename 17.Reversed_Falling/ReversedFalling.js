...
const radiusHours = 175; // Der Radius des Stundenkreises (150px)
const radiusMinutes = 275; // Der Radius des Minutenkreises (250px)
...
// function update() {
//   const timeScale = 500;
//   pulseTime += 0.05 * timeScale; // Zeit schneller laufen lassen

//   // Rest deines Codes
//   requestAnimationFrame(3000);
// }
...
function draw() {
  ...
  // let scaleFactor2 = sin(pulseTime) * 0.5 + 1; // Sinusfunktion für pulsierende Skalierung
  // pulseTime += 30; // Inkrementiere die Zeit für das Pulsieren
  
  // fill(255, 255, 255, 10); // Eine graue Farbe für den Mittelpunkt
  // circle(center.position.x, center.position.y, 350 * scaleFactor2); // Kreis mit doppeltem Radius, weil p5.js `diameter` nutzt

  // // Berechne das Pulsieren (von 0 bis 1)
  // let scaleFactor3 = sin(pulseTime) * 0.5 + 1.5; // Sinusfunktion für pulsierende Skalierung
  // pulseTime += 20; // Inkrementiere die Zeit für das Pulsieren


  // fill(20, 20, 20); // Eine graue Farbe für den Mittelpunkt
  // noStroke();
  // circle(center.position.x, center.position.y, 400 * scaleFactor3); // Kreis mit doppeltem Radius, weil p5.js `diameter` nutzt
  
  // // Berechne das Pulsieren (von 0 bis 1)
  // let scaleFactor4 = sin(pulseTime) * 0.5 + 1; // Sinusfunktion für pulsierende Skalierung
  // pulseTime += 15; // Inkrementiere die Zeit für das Pulsieren
  
  // fill(255, 255, 255); // Eine graue Farbe für den Mittelpunkt
  // circle(center.position.x, center.position.y, 100 * scaleFactor4); // Kreis mit doppeltem Radius, weil p5.js `diameter` nutzt

  // Berechne das Pulsieren (von 0 bis 1)
  let scaleFactor = sin(pulseTime) * 0.5 + 1; // Sinusfunktion für pulsierende Skalierung
  pulseTime += 0.05; // Inkrementiere die Zeit für das Pulsieren


  fill(50, 50, 50, 100); // Eine graue Farbe für den Mittelpunkt
  noStroke();
  ...
  for (let i = 0; i < hours.length; i++) {
    ...
    fill(50, 50, 50, 0); // Graue Farbe mit Transparenz
    noStroke(); // Kein Rand
    circle(x, y, r - 15); // Zeichne den Platzhalterkreis
  }
  ...
  for (let i = 0; i < seconds.length; i++) {
    ...
    fill(255, 255, 255, 50); // Graue Farbe mit Transparenz
    noStroke(); // Kein Rand
    circle(x, y, r - 5); // Zeichne den Platzhalterkreis
  }

  // Stundenmarkierungen zeichnen
  for (let i = 0; i < hours.length; i++) {
    if (i <= (hour() % 12) && !hours[i].fallen) {
